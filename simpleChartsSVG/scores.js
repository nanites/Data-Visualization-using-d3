...
//Scatter plot 1 and the axis
var scatterplot_1 = make("svg", {width:500,height:500});
document.getElementById("scatterplot_1").appendChild(scatterplot_1);
plotAll(scatterplot_1, scores, "circle",{
    cx: function(row){return (row.SATM/800)*400},
    cy: function(row){return 500 - (row.SATV/800)*400},
    r: function(row){return (row.ACT/35)*5},
    fill: function(row){return rgb(row.GPA/4,row.GPA/4,row.GPA/4)}
});

var x_axis = [{x1:80,y1:440,x2:500,y2:440}];
var y_axis = [{x1:80,y1:440,x2:80,y2:0}];

plotAll(scatterplot_1, x_axis,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
    stroke: function() {return "black"},
    style: function() {return "stroke-width:2"}
});

plotAll(scatterplot_1, y_axis,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
...
var x_tick = [
{x1:(200/800)*400,y1:440,x2:(200/800)*400,y2:450},
{x1:(400/800)*400,y1:440,x2:(400/800)*400,y2:450},
{x1:(600/800)*400,y1:440,x2:(600/800)*400,y2:450},
{x1:(800/800)*400,y1:440,x2:(800/800)*400,y2:450}
];
var y_tick = [
{x1:80,y1:(500-200/2),x2:70,y2:(500-200/2)},
{x1:80,y1:(500-400/2),x2:70,y2:(500-400/2)},
{x1:80,y1:(500-600/2),x2:70,y2:(500-600/2)},
{x1:80,y1:(500-800/2),x2:70,y2:(500-800/2)}
];
plotAll(scatterplot_1,x_tick,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
...
plotAll(scatterplot_1,y_tick,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
...
//Scatter plot 2 and the axis
//Playing around with the color a bit (B/W looks boring)
var scatterplot_2 = make("svg", {width:500,height:500});
document.getElementById("scatterplot_2").appendChild(scatterplot_2);
plotAll(scatterplot_2, scores, "circle",{
    cx: function(row){return (row.ACT/35)*400},
    cy: function(row){return 500 - (row.GPA/4)*400},
    r: function(row){return (row.SATM/800)*5},
    fill: function(row){return rgb((row.SATV/800)*1/2,(row.SATV/800)*1,(row.SATV/800)*1)}
});

var x_axis = [{x1:80,y1:440,x2:500,y2:440}];
var y_axis = [{x1:80,y1:440,x2:80,y2:0}];

plotAll(scatterplot_2, x_axis,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
...
plotAll(scatterplot_2, y_axis,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
...
var x_tick = [
{x1:(9/35)*400,y1:440,x2:(9/35)*400,y2:450},
{x1:(18/35)*400,y1:440,x2:(18/35)*400,y2:450},
{x1:(27/35)*400,y1:440,x2:(27/35)*400,y2:450},
{x1:(36/35)*400,y1:440,x2:(36/35)*400,y2:450}
];
var y_tick = [
{x1:80,y1:(500-1*100),x2:70,y2:(500-1*100)},
{x1:80,y1:(500-2*100),x2:70,y2:(500-2*100)},
{x1:80,y1:(500-3*100),x2:70,y2:(500-3*100)},
{x1:80,y1:(500-4*100),x2:70,y2:(500-4*100)}
];
plotAll(scatterplot_2,x_tick,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
...
plotAll(scatterplot_2,y_tick,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
...
//Scatter plot 3 and the axis
//Playing with the colors with this one too
//Setting the radius for each to 5
var scatterplot_3 = make("svg", {width:500,height:500});
document.getElementById("scatterplot_3").appendChild(scatterplot_3);
plotAll(scatterplot_3, scores, "circle",{
    cx: function(row){return ((row.SATM+row.SATV)/1600)*400},
    cy: function(row){return 500 - (row.GPA/4)*400},
    r: function(row){return 5},
    fill: function(row){return rgb(row.ACT/35,row.ACT/70,row.ACT/35)}
});

var x_axis = [{x1:80,y1:440,x2:500,y2:440}];
var y_axis = [{x1:80,y1:440,x2:80,y2:0}];

plotAll(scatterplot_3, x_axis,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
...
plotAll(scatterplot_3, y_axis,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
...
var x_tick = [
{x1:(400/1600)*400,y1:440,x2:(400/1600)*400,y2:450},
{x1:(800/1600)*400,y1:440,x2:(800/1600)*400,y2:450},
{x1:(1200/1600)*400,y1:440,x2:(1200/1600)*400,y2:450},
{x1:(1600/1600)*400,y1:440,x2:(1600/1600)*400,y2:450}
];
var y_tick = [
{x1:80,y1:(500-1*100),x2:70,y2:(500-1*100)},
{x1:80,y1:(500-2*100),x2:70,y2:(500-2*100)},
...
plotAll(scatterplot_3,x_tick,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
...
plotAll(scatterplot_3,y_tick,"line",{
    x1: function(row){return row.x1},
    y1: function(row){return row.y1},
    x2: function(row){return row.x2},
    y2: function(row){return row.y2},
